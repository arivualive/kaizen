    ...
    <div id="maincontents">
        ...
        <div class="h2">
            ...
            <ul class='btns-mode'>
                ...
                <li><a href='sorting.php?bid=" . $subject_section_id . "'>並べ替え</a></li>
                <li><a href='folder.php?bid=" . $subject_section_id . "'>フォルダ</a></li>
            </ul> ";
                    } else if ($isManager || isPermissionFlagOn($permission, "1-10")) {
                echo "
            <ul class='btns-mode'>
                <li class='active'><a>削除</a></li>
            </ul> ";
                    }
                }
            ?>
               ...
               <?php
                ...
                <div class='topbtngroup clearfix'>
                    ...
                    <div class='btn-newregist'>
                        ...
                        <p class='text'>新規登録</p>
                        <ul>
                            <li class='movie'><a href='../movie/regist.php?bid=" . $subject_section_id . "'>動画授業</a></li>
                            <li class='test'><a href='../quiz/create.php?bid=" . $subject_section_id . "'>テスト</a></li>
                            <li class='questionnaire'><a href='../questionnaire/regist.php?bid=" . $subject_section_id . "'>アンケート</a></li>
                            <li class='report'><a href='../report/regist.php?bid=" . $subject_section_id . "'>レポート</a></li>
                        </ul>
                    </div>";
                    }
                    ...
                    <div class='btngroup-sortcontrol'>
                        ...
                        <div class='button-dropdown item-sort'>
                            <p class='text'>絞り込み</p>
                            <a class='link all-sort' href='javascript:void(0)'>全て</a>
                            <ul class='submenu'>
                                <li class='sort-dummy-01 all-sort'><a>全て</a></li>
                                <li class='sort-dummy-02 movie'><a>動画授業</a></li>
                            ...
                            <?php
                                if($item['bit_classroom'] == $bit_classroom && $item['parent_function_group_id'] == '0') {
                                    ...
                                    case 0:
                                        if ($item['contents_extension_id'] <= 6) {
                                            ...
                                            if ($isManager || isPermissionFlagOn($permission, "1-10")) {
                                                echo "
                                                            <form action=" . $_SERVER['REQUEST_URI'] . " method='POST' onsubmit=\"return submitCheck('コンテンツを削除します。よろしいですか？')\">
                                    ...
                                    case 1:
                                        ...
                                        if ($isManager || isPermissionFlagOn($permission, "1-10")) {
                                            echo "
                                                        <form action=" . $_SERVER['REQUEST_URI'] . " method='POST' onsubmit=\"return submitCheck('アンケートを削除します。よろしいですか？')\">
                                                            <li class='delete'><button></button></li>
                                                            <input type='hidden' name='delete_flag' value='1' />
                                                            <input type='hidden' name='primary_id' value='" . $item['primary_key'] . "'/>
                                                            <input type='hidden' name='type' value='" . $item['type'] . "'/>
                                    ...
                                    case 2:
                                        ...
                                        if ($isManager || isPermissionFlagOn($permission, "1-10")) {
                                            echo "
                                                        <form action=" . $_SERVER['REQUEST_URI'] . " method='POST' onsubmit=\"return submitCheck('レポートを削除します。よろしいですか？')\">
                                                            <li class='delete'><button></button></li>
                                                            <input type='hidden' name='delete_flag' value='1' />
                                                            <input type='hidden' name='primary_id' value='" . $item['primary_key'] . "'/>
                                                            <input type='hidden' name='type' value='" . $item['type'] . "'/>
                                    ...
                                    case 3:
                                        ...
                                        if ($isManager || isPermissionFlagOn($permission, "1-10")) {
                                            echo "
                                                        <form action=" . $_SERVER['REQUEST_URI'] . " method='POST' onsubmit=\"return submitCheck('テストを削除します。よろしいですか？')\">
                                                            <li class='delete'><button></button></li>
                                                            <input type='hidden' name='delete_flag' value='1' />
                                                            <input type='hidden' name='primary_id' value='" . $item['primary_key'] . "'/>
                                                            <input type='hidden' name='type' value='" . $item['type'] . "'/>
