$(function() {
    ...
    $('.create_form').on('click', function() {
        if($('.input_name').val() != '') {
            ...
            $('input[name=create_folder_name]').val('Untitled folder');
        }
        $('.create_form').submit();
    });
    ...
    $($('.checkbox.folder').find('.list_check')).on('click', function() {
        if($(this).prop('checked')) {
            ...
            $('.text-top').html('<img src="../images/ico_folder_s.png"> selecting');
            ...
            //[フォルダ名]入力欄の内容を空にする
            $('.text-top').html('<img src="../images/ico_folder_p.png"> Create New');
            $('.input_name').val('');
