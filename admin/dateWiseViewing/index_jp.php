            ...
            <div id="userinfo" class="button-dropdown">
                ...
                <ul class="submenu">
                    <li role="presentation">
                        <a href="#">
                            <span class="icon-lock"></span>パスワード変更
                        </a>
                    </li>
                    <li role="presentation">
                        <a href="../auth/logout.php">
                            <span class="icon-sign-in"></span>ログアウト
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-speedmeter">
                    <nav>
                        <ul>
                            <li class="title">
                                <div id="stop-speed">
                                    <span id="stop">停止・シーク</span>
                                </div>

                                <div id="normal-speed">
                                    <span id="normal">等倍</span>
                                </div>

                                <div id="double-speed">
                                    <span id="double">2倍速</span>
                                </div>

                                <div id="triple-speed">
                                    <span id="triple">3倍速</span>
                                </div>

                                <div id="quadruple-speed">
                                    <span id="quadruple">4倍速</span>
                                </div>
                            </li>
                            <li>
