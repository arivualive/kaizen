...
<div id="wrap">
    ...
    <div id="maincontents">
        ...
        <div>
          ...
          <button id="single" onclick="document.getElementById('single-csv').click()">CSVダウンロード</button>
          ...
          <a href="" download="" id="multi-csv" hidden></a>
          <button onclick="document.getElementById('multi-csv').click()">全受講者CSVダウンロード</button>
