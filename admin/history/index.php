...
<div id="wrap">
    ...
    <div id="header">
        ...
        <div id="topicpath">
            <ol>
                ...
                <li class="active"><a>Confirmation from the student</a></li>
            </ol>
        </div>
        <!-- ▼user information -->
    ...
    <div id="maincontents">
        ...
        <!-- ▼h2 -->
        <div class="h2">
            <h2>Confirmation from the student</h2>
        </div>
        <!-- ▲h2 -->
        ...
        <div>
          ...
          <button class="attribute_btn" id="attribute" value="OFF">Affiliation indication</button>
          &nbsp;
          <a href="#single-csv" id="single-csv" hidden></a>
          <button id="single" onclick="document.getElementById('single-csv').click()">CSV output</button>
          <a href="#multi-csv" id="multi-csv" hidden></a>
          <button id="multi" onclick="document.getElementById('multi-csv').click()">Detailed CSV output</button>
          ...
          <div id="divhTable">
            <div class="table-to-export" data-sheet-name="Course history" id=""></div>
          </div>
          ...
          <p class="student_history" id="inputNumber"><label>Student No.
          ...
          <button class="outputcsv_btn" id="download-csv2" disabled >CSV output</button>
