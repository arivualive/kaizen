...
foreach($select_section as $key => $qe_contents) {
  ...
  if(empty($contents)) {
    ...
    $select_section[$key]['contents'] = "There are no contents.";
  ...
  if(empty($quiz)) {
    ...
    $select_section[$key]['quiz'] = "There is no quiz.";
...
*/
  if(empty($questionnaire)) {
    ...
    $select_section[$key]['questionnaire'] = "There is no questionnaire.";
  ...
  if(empty($report)) {
    ...
    $select_section[$key]['report'] = "There is no report.";
...
foreach($return_data['student_data'] as $key => $data) {
  ...
  foreach($data as $key_1 => $value) {
    if($key_1 === 'number') {
      ...
      $return_data['table_create'][1]['title'] = 'Student ID';
      ...
      $return_data['table_create'][2]['title'] = 'Student name';
      ...
      if(strpos($key_name,'-') !== 0) {
        ...
        switch($trimed) {
          ...
          //debug_r($value);
            ...
            $return_data['table_create'][$num_c]['title'] = 'Affiliation 1';
          ...
          case 'g':
            ...
            //$return_data['table_create'][$num_c]['title'] = $trimed_name;
            $return_data['table_create'][$num_c]['title'] = 'Affiliation 2';
            $return_data['table_create'][$num_c]['field'] = $key_name;
            $return_data['table_create'][$num_c]['width'] = 100;
            $return_data['table_create'][$num_c]['headerFilter'] = 'input';
            $return_data['table_create'][$num_c]['align'] = 'center';
          ...
          case 'cl':
            ...
            //$return_data['table_create'][$num_c]['title'] = $trimed_name;
            $return_data['table_create'][$num_c]['title'] = 'Affiliation 3';
            $return_data['table_create'][$num_c]['field'] = $key_name;
            $return_data['table_create'][$num_c]['width'] = 100;
            $return_data['table_create'][$num_c]['headerFilter'] = 'input';
            $return_data['table_create'][$num_c]['align'] = 'center';
          ...
          case 'cs':
            ...
            //$return_data['table_create'][$num_c]['title'] = $trimed_name;
            $return_data['table_create'][$num_c]['title'] = 'Affiliation 4';
            $return_data['table_create'][$num_c]['field'] = $key_name;
            $return_data['table_create'][$num_c]['width'] = 100;
            $return_data['table_create'][$num_c]['headerFilter'] = 'input';
            $return_data['table_create'][$num_c]['align'] = 'center';
...
if($section_count > 0) {
  for($sc = 0; $sc < $section_count; ++$sc) {
    ...
    $return_data['csv_header'][] = $access_code[$sc][3] . ' - Video';
    $return_data['csv_header'][] = $access_code[$sc][3] . ' - Quiz';
    $return_data['csv_header'][] = $access_code[$sc][3] . ' - Questionnaire';
    $return_data['csv_header'][] = $access_code[$sc][3] . ' - Report';
  }
}
