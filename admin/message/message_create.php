    ...
    <div id="header">
        ...
        <div id="topicpath">
            <ol>
                ...
                <li class="active"><a>Create new message</a></li>
            </ol>
        </div>
        <!-- ▼user information -->
                ...
                <div class="message-create-body">
                                                ...
                                                <?php if(true) {
                                                    echo "
														<div class='user-group'>
															<span class='h'>Group membership</span>
                    ...
                    <div id="message-create" class="item">
                        ...
                        <div class="body">
                            ...
                            <div id="message-title" class="input-category">
                                <p class="title">title<small>Within 100 characters</small></p>
                    ...
                    <div id="message-notice" class="item">
                        ...
                        <div class="body">
                            <dl class="input-group">
                            	...
                            	<p class="attention">If you do not enter it, it will be set in the period from one month after the posting.</p>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div id="message-importance" class="item">
                        ...
                        <div class="body">
                            <div>
                                <ul class="clearfix">
                                    <li><label class="checkbox"><input type="radio" name="message_level" class="input-level" value=0 ?><span class="icon"></span>most important</label></li>
                                    <li><label class="checkbox"><input type="radio" name="message_level" class="input-level" value=1 ?><span class="icon"></span>important</label></li>
                                    <li><label class="checkbox"><input type="radio" name="message_level" class="input-level" value=2 checked="checked" ?><span class="icon"></span>usually</label></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="message-type" class="item">
                        ...
                        <div class="body">
                            <div>
                                <ul class="clearfix">
                                    <li><label class="checkbox"><input type="radio" name="type" class="input-type" value=0 checked="checked" ?><span class="icon"></span>Notice</label></li>
                                    <li><label class="checkbox"><input type="radio" name="type" class="input-type" value=1 ?><span class="icon"></span>Group message</label></li>
                                    <li><label class="checkbox"><input type="radio" name="type" class="input-type" value=2 ?><span class="icon"></span>Private message</label></li>
                                </ul>
                            </div>
                        </div>
                    </div>
