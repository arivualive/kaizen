        ...
        <form action="" method="post" name="send_form" id="send_form" enctype="multipart/form-data">
                    ...
                    <div class="body">
                        ...
                        <div class="clearfix">
                            ...
                            <dl class="input-group day-limit clearfix">
                                <dt>コンテンツ再生</dt>
                                <dd>
                                    <button type="button" id="play_button" data-filePath='<?php echo $data[ 'file_path' ]; ?>'>再生</button>
                                </dd>
                                <p class="attention">※登録した動画の視聴を行います</p>
                            </dl>
                        </div>
                        <!-- 添付ファイル -->
                        <dl class="input-group border-top">
                            <?php
                                if(isset($attachData['file_name'])) {
                                    echo "
                                        <div id='attach_on'>
                                            <dt>添付ファイル<button class='cancel' type='button'>削除</button></dt>

                                              <dd id='attach_on_file_function'>
                                                  <button form='attach_form' data-tooltip='クリックしてダウンロードできます' class='attachment_hidden' type='submit' name='id' value=".$attachData[ 'contents_attachment_id' ].">". $attachData['file_name'] ."</button>
                                                  <input type='hidden' form='attach_form' name='name'  value='".$attachData[ 'file_name' ]."'/>
                                              </dd>
                                        </div>

                                        <div id='attach_off' style='display:none;'>
                                            <dt>添付ファイル<button class='cancel' type='button'>取消</button></dt>
            ...
            <div id="col-mainbtn" class="clearfix">
                <ul class="clearfix">
                    ...
                    ?>
                    <li class="save" name="submit"><button form="send_form" id="submit">保 存</button></li>
