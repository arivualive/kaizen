...
if (filter_input(INPUT_POST, "send_flag" )) {
    ...
    if($subject_section_id == 0) {
        $error = 1;
        $error_strings .= "科目-講義が選択されていません。</br>";
    }
    ...
    if(filter_input(INPUT_POST, "contents_name")) {
        ...
        $error = 1;
        $error_strings .= "タイトルが入力されていません。</br>";
    }
    ...
    if($_FILES['contents_file']['name'] !== '') {
        ...
        switch(strtoupper($file_info[1])) {
            ...
            default: // 該当なし
                $error = 1;
                $error_strings .= "未対応の拡張子を持つファイルが選ばれています。</br>";
                break;
        }
        ...
        $error = 1;
        $error_strings .= "動画ファイルが選択されていません。</br>";
    }
                ...
                <div id="control-box-formgroup">
                    ...
                    <div class="body">
                        ...
                        <dl class="input-group border-top">
                            ...
                            <p class="attention">※MP4動画のデータサイズは150MBまでです。</p>
                                <?php
                                    if($data['contents_file'] == 'not file') {
                                        echo "<p class='attention' id='contents_not_file'>動画ファイルを添付してください</p>";
                                    }
                                ?>
                        </dl>
                        <!-- 添付ファイル -->
