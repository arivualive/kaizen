    ...
    <div id="header">
        ...
        <div id="topicpath">
            <ol>
                ...
                <li class="active"><a>アンケート編集</a></li>
            </ol>
        </div>
        <!-- ▼user information -->
                                                ...
                                                <dl class='input-group type-questionnaire'>
                                                    ...
                                                    <dd class='clearfix'>
                                                        <select class='form-list' name='query_type[" . $i . "]' style='background-color:#ddd;'>
                                                            <option value='0' selected>単一選択形式</option>
                                                            <option value='1' disabled>複数選択形式</option>
                                                            <option value='2' disabled>自由回答形式</option>
                                                            <option value='3' disabled>数値回答形式</option>
                                                        </select>
                                ";
                                                        if($queryData[$i]['flg_query_must'] == 0) {
                                echo "
                                        ...
                                        <div class='info-erea create'>
                                            <div class='in'>
                                                <dl class='input-group type-questionnaire'>
                                                    ...
                                                    <dd class='clearfix'>
                                                        <select class='form-list' name='query_type[" . $i . "]' style='background-color:#ddd;'>
                                                            <option value='0' disabled>単一選択形式</option>
                                                            <option value='1' selected>複数選択形式</option>
                                                            <option value='2' disabled>自由回答形式</option>
                                                            <option value='3' disabled>数値回答形式</option>
                                                        </select>
                                ";
                                                ...
                                                <dl class='input-group type-questionnaire'>
                                                    ...
                                                    <dd class='clearfix'>
                                                        <select class='form-list' name='query_type[" . $i . "]' style='background-color:#ddd;'>
                                                            <option value='0' disabled>単一選択形式</option>
                                                            <option value='1' disabled>複数選択形式</option>
                                                            <option value='2' selected>自由回答形式</option>
                                                            <option value='3' disabled>数値回答形式</option>
                                                        </select>
                                ";
                                                        if($queryData[$i]['flg_query_must'] == 0) {
                                                ...
                                                <dl class='input-group type-questionnaire'>
                                                    ...
                                                    <dd class='clearfix'>
                                                        <select class='form-list' name='query_type[" . $i . "]' style='background-color:#ddd;'>
                                                            ...
                                                            <option value='1' disabled>複数選択形式</option>
                                                            <option value='2' disabled>自由回答形式</option>
                                                            <option value='3' selected>数値回答形式</option>
                                                        </select>
                                ";
                                                        if($queryData[$i]['flg_query_must'] == 0) {
                                echo "
                                ...
                                echo "
                                                ...
                                                <div class='clearfix'>
                                                    <dl class='input-group value-answer'>
                                                        <dt>数値入力</dt>
                                                        <dd>
                                                            <input type='text' maxlength='20' placeholder='最小値のラベル' class='label' name='min_label[" . $i . "]' value='" . $queryData[$i][0]['min_label'] . "' readonly style='background-color:#ddd;'>
                                                            <input type='number' name='min_limit[" . $i . "]' value='" . $queryData[$i][0]['min_limit'] . "' readonly style='background-color:#ddd;'>
                                                            <p>～</p>
                                                            <input type='text' maxlength='20' placeholder='最大値のラベル' class='label' name='max_label[" . $i . "]' value='" . $queryData[$i][0]['max_label'] . "' readonly style='background-color:#ddd;'>
