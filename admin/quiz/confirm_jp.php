...
-->
                            <tr>
                                <th>解説文</th>
                                <td style="white-space:pre-wrap;"><?php echo ($item['description'] == '')? '設定なし' : $item['description']; ?></td>
                            </tr>
                            <!--
                            <tr>
                                <th>解説コンテンツ</th>
...
<input type="hidden" name="bid" value="<?php echo $bid; ?>">
        <div id="col-mainbtn" class="clearfix">
            <ul class="clearfix">
                <li class="save"><button type="submit" name="submit" value="save">保存</button></li>
            </ul>
        </div>
        </form>
