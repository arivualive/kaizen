    ...
    for($i = 0 ; $i < count($_POST['query_type']) ; $i++) {
        if($_POST['query_type'][$i] == 0) {
            ...
            for($j = 0 ; $j < count($_POST['text'][$i]) ; $j++) {
                if($_POST['text'][$i][$j] == "") {
                    $error = 1;
                    $error_string .= "<span class='icon'></span>Q" . ($i + 1) . ".Single response format - There is a blank option.<br>(" . ($j + 1) . "番目の選択肢)<br>値を設定するか、選択肢を削除してください。<br>";
                }
            }
            ...
            for($j = 0 ; $j < count($_POST['text'][$i]) ; $j++) {
                if($_POST['text'][$i][$j] == "") {
                    $error = 1;
                    $error_string .= "<span class='icon'></span>Q" . ($i + 1) . ".Multiple response format - There is a blank option.<br>(" . ($j + 1) . "番目の選択肢)<br>値を設定するか、選択肢を削除してください。<br>";
                }
            }
        ...
        <div id="scrollerea">
            <nav id="mainnav">
                <ul id="accordion" class="accordion">
                    ...
                    <li>
                        <a class="togglebtn"><span class="icon-graph"></span>Target setting</a>
                        <ul class="togglemenu">
    ...
    <div id="header">
        ...
        <div id="topicpath">
            <ol>
                ...
                <li class="active"><a>Report replication</a></li>
            </ol>
        </div>
        <!-- ▼user information -->
