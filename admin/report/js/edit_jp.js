                        ...
                        "<div class='in'>" +
                            "<dl class='input-group type-questionnaire'>" +
                                ...
                                "<dd class='clearfix'>" +
                                    ...
                                    "</select>" +
                                    "<p class='any-required'><label class='checkbox'><input type='radio' name='flg_query_must[" + (formCount-1) + "]' value='0' checked><span class='icon'></span>任意回答</label></p>" +
                                    "<p class='any-required'><label class='checkbox'><input type='radio' name='flg_query_must[" + (formCount-1) + "]' value='1'><span class='icon'></span>必須回答</label></p>" +
                                "</dd>" +
                            "</dl>" +
    ...
    */
            ...
            $(this).parents('.info-erea').append(
                "<div class='in'>" +
                    "<dl class='input-group type-questionnaire'>" +
                        ...
                        "<dd class='clearfix'>" +
                            "<select class='form-list' name='query_type[" + formChoicesNumber + "]'>" +
                                ...
                                "<option value='3'>数値回答形式</option>" +
                            "</select>" +
                            "<p class='any-required'><label class='checkbox'><input type='radio' name='flg_query_must[" + formChoicesNumber + "]' value='0' checked><span class='icon'></span>任意回答</label></p>" +
                            "<p class='any-required'><label class='checkbox'><input type='radio' name='flg_query_must[" + formChoicesNumber + "]' value='1'><span class='icon'></span>必須回答</label></p>" +
                        "</dd>" +
                    "</dl>" +
                    "<dl class='input-group'>" +
                        "<dt>質問文<span class='text_limit'>500文字以内</span></dt>" +
                    ...
                    "<dl class='input-group select-answer'>" +
                        ...
                        "<dd class='item'><input type='text' maxlength='100' name='text[" + formChoicesNumber + "][0]'><button class='delete item'>削 除</button></dd>" +
                        "<dd class='item'><input type='text' maxlength='100' name='text[" + formChoicesNumber + "][1]'><button class='delete item'>削 除</button></dd>" +
                ...
                "<div class='in'>" +
                    ...
                    "<div class='clearfix'>" +
                        "<dl class='input-group value-answer'>" +
                            "<dt>数値入力</dt>" +
                            "<dd>" +
                                "<input type='text' placeholder='最小値のラベル' maxlength='20' class='label' name='min_label[" + formChoicesNumber + "]'>" +
                                "<input type='number' name='min_limit[" + formChoicesNumber + "]' value='1'>" +
                                "<p>～</p>" +
                                "<input type='text' placeholder='最大値のラベル' maxlength='20' class='label' name='max_label[" + formChoicesNumber + "]'>" +
    ...
    $('#question').on('click', '.insert.item', function() {
        ...
        $(this).parents('.input-group.select-answer').append(
            "<dd class='item'><input type='text' maxlength='100'><button class='delete item'>削 除</button></dd>" +
            "<dd class='add'><button class='insert item'>項目追加</button></dd>"
        );
