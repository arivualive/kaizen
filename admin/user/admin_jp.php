    ...
    <div id="nav-fixed">
        ...
        <nav id="mainnav">
                <ul id="accordion" class="accordion">
                    ...
                    <?php if ($isManager) { ?>
                    <li class="open">
                        <a href="../user/admin.php" class="active"><span class="icon-user-add"></span>管理者ID・権限設定</a>
                    </li>
                    <?php }; ?>
                </ul>
            </nav>
    ...
    <div id="header">
        ...
        <div id="topicpath">
            <ol>
                ...
                <li>管理者所属・ID設定</li>
                <li class="active"><a>管理者ID・権限設定</a></li>
            </ol>
        </div>
        <!-- ▼user information -->
                    ...
                    <table class="sort">
                        ...
                        <!--  <tr> 新規登録 -->
                            <tr class='listvalue new-user'><!-- 選択時 class="active" -->
                                ...
                                <!-- 氏名 -->
                                <td class="new" colspan="2"><p>新規登録</p></td>
                            </tr>
                    </table>
                            ...
                            <?php } ?>
                                ...
                                <td class="delete">
                                    <?php if ($items['enable'] == 1) { ?>
                                        <span class="maru">有効</span>
                                    <?php } else { ?>
                                        <span class="batu">無効</span>
                                    <?php } ?>
                                    <!--
            ...
            <div id="controlerea">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="new-regist" role="tabpanel">
                        <?php
                            if($data['admin_id'] != 0) {
                                echo "<form action='" . $_SERVER['REQUEST_URI'] . "' method='POST' onsubmit=\"return submitCheck('管理者情報を変更します。よろしいですか？')\">";
                            } else {
                                echo "<form action='" . $_SERVER['REQUEST_URI'] . "' method='POST' onsubmit=\"return submitCheck('管理者情報を登録します。よろしいですか？')\">";
                            }
                        ?>
                            <div class="clearfix">
                                <!-- 管理者氏名 -->
                            ...
                            <div class="clearfix">
                                ...
                                <dl class="input-group w-50">
                                    <dt>管理者ID</dt>
                                    <dd class="set-btn">
                                        <input type="text" maxlength="100" name="id" value="<?php echo $admin_data['id'] ?>"><input type="button" id="auto_student_id" value="自動作成">
                                    </dd>
                                    <?php
                                        if(!isset($data['id']) && filter_input(INPUT_POST, "insert_flag")) {
                                            echo "<p class='attention' id='not_id'>管理者IDが入力されていません</p>";
                                        } else if($id_error) {
                                            echo "<p class='attention' id='overlaped_id'>管理者IDに重複があります。別の値を入力して下さい。</p>";
                                        }
                                    ?>
                                </dl>
                                <!-- パスワード -->
                                <dl class="input-group w-50">
                                    ...
                                    <?php
                                        if($data['admin_id'] == 0) {
                                            echo "
                                                <dd class='set-btn'>
                                                    <input type='text' maxlength='100' name='password' value='" . $admin_data['password'] . "'><input type='button' id='auto_student_password' value='自動作成'></input>
                                                </dd>
                                            ";
                                        } else {
                                            echo "
                        ...
                        <?php if (!isset($_GET["id"]) || $_GET["id"]==0 || $admin_data["manage"]==0) { ?>
                            <dl class="input-group clearfix">
                                <dt>稼働状態</dt>
                                <dd>
                                    <label class="checkbox"><input type="radio" name="enable" value="1" value="<?php if( $admin_data['enable'] == 1) { echo '"checked="true'; } ?>"><span class="icon"></span><span class="t"></span>有効</label>
                                    <label class="checkbox"><input type="radio" name="enable" value="0" value="<?php if( $admin_data['enable'] == 0) { echo '"checked="true'; } ?>"><span class="icon"></span><span class="f"></span>無効</label>
                                </dd>
                            </dl>
                        <?php } else { ?>
                        ...
                        <?php } ?>
                            ...
                            <dl class="input-group clearfix">
                                <dt>管理者ID・権限設定</dt>
                                <dd>
                                    <label class="checkbox"><input type="radio" name="manage" value="1" <?php //if( $admin_data['manage'] == 1) { echo '"checked="true'; } ?>><span class="icon"></span><span class="t"></span>有効</label>
                                ...
                                <dd>
                                    ...
                                    <ul class="padding padding1">
                                        <span class="item2">
                                            ...
                                            <input type="hidden" name="save[]" value="1{}1-0x1000{}{}受講者ID設定{}">
                                            <input type="checkbox" name="permission[]" value="1-0x1000" id="p000" <?php setPermissionCheck($permissionString, "1-1000"); ?>>
                                            <label class="label label1" for="p000">受講者ID設定（閲覧）</label>
                                        </span>
                                        <ul class="padding">
                                            <div class="padding2">
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x2{}1-0x1000{}登録・編集{}">
                                                    ...
                                                    <label class="label label4" for="p001">登録・編集</label>
                                                </span>
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x4{}1-0x1000{}削除{}">
                                                    ...
                                                    <label class="label label4" for="p002">削除</label>
                                                </span>
                                            </div>
                                        </ul>
                                        <span class="item2">
                                            <input type="checkbox" name="folder">
                                            <label class="mark angle">&#xf078;</label>
                                            <input type="hidden" name="save[]" value="1{}1-0x2000{}{}コンテンツ設定{}">
                                            <input type="checkbox" name="permission[]" value="1-0x2000" id="p003" <?php setPermissionCheck($permissionString, "1-2000"); ?>>
                                            <label class="label label1" for="p003">コンテンツ設定（閲覧）</label>
                                        </span>
                                        <ul class="padding">
                                            <div class="padding2">
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x8{}1-0x2000{}登録・編集{}">
                                                    ...
                                                    <label class="label label4" for="p004">登録・編集</label>
                                                </span>
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x10{}1-0x2000{}削除{}">
                                                    ...
                                                    <label class="label label4" for="p005">削除</label>
                                                </span>
                                            </div>
                                        </ul>
                                        <span class="item2">
                                            <input type="checkbox" name="folder">
                                            <label class="mark angle">&#xf078;</label>
                                            <input type="hidden" name="save[]" value="1{}1-0x4000{}{}メッセージ{}">
                                            <input type="checkbox" name="permission[]" value="1-0x4000" id="p006" <?php setPermissionCheck($permissionString, "1-4000"); ?>>
                                            <label class="label label1" for="p006">メッセージ（閲覧）</label>
                                        </span>
                                        <ul class="padding">
                                            <div class="padding2">
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x40{}1-0x4000{}新規作成{}">
                                                    ...
                                                    <label class="label label4" for="p007">新規作成</label>
                                                </span>
                                                <span class="item1">
                                                    <input type="hidden" name="save[]" value="2{}1-0x80{}1-0x4000{}削除{}">
                                                    ...
                                                    <label class="label label4" for="p008">削除</label>
                                                </span>
                                            </div>
                                        </ul>
                                        <div class="padding2">
                                            <span class="item1">
                                                <input type="hidden" name="save[]" value="1{}1-0x1{}{}所属・コンテンツグループ設定、受講対象設定{}">
                                                <input type="checkbox" name="permission[]" value="1-0x1" id="p009" <?php setPermissionCheck($permissionString, "1-1"); ?>>
                                                <label class="label label4" for="p009">所属・コンテンツグループ設定、受講対象設定</label>
                                            </span>
                                            <span class="item1">
                                                <input type="hidden" name="save[]" value="1{}1-0x20{}{}受講状況{}">
                                                <input type="checkbox" name="permission[]" value="1-0x20" id="p010" <?php setPermissionCheck($permissionString, "1-20"); ?>>
                                                <label class="label label4" for="p010">受講状況</label>
                                            </span>
                                        </div>
                                    </ul>
                                    </div>
                                    <?php
                                        if($permission_error) {
                                            echo "<p class='attention'>※パーミッションが選択されていません</p>";
                                        }
                                    ?>
                                </dd>
                            </dl>
