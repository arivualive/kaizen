...
class GetAdminMessageDetailModel extends PdoBase
{
    ...
    public function getMessageDetailOffset($data)
    {
        $sql = " SELECT b.message_detail_id
                      ...
                      , b.send_user_level_id = 1 AND b.send_user_id = :admin_id as send_flag
                      , b.enable
                      , CASE
    ...
    public function getMessageDetailReceiver($data)
    {
        $sql = " SELECT (SELECT grade_name
                      ...
                      , CASE
                            ...
                            WHEN receive_user_level_id = 3 THEN
                                (SELECT student_name
                                   FROM tbl_student
