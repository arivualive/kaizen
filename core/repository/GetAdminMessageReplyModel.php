...
class GetAdminMessageReplyModel extends PdoBase
{
    public function getMessageReplyStudentList($data)
    {
        $sql = " SELECT c.student_id
              ...
              LEFT JOIN tbl_student as c
                     ON (a.send_user_id = c.student_id AND a.send_user_level_id = 3)
                     OR (b.receive_user_id = c.student_id AND b.receive_user_level_id = 3)
