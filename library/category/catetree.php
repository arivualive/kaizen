...
<span id="text"><i class="<?php echo ($_POST['mode'] == 2) ? 'fas fa-tablet-alt fa-fw"></i>Browse' : 'far fa-hand-point-up fa-fw"></i>Select' ?>mode</span>
...
<button><i class="fas fa-save"></i><?php echo ($_POST['mode'] == 3) ? ' 選択と編集' : (($_POST['mode'] == 2) ? ' Edit' : ' Select') ?> Save item</button>&ensp;
<?php } ?>
<button type="button" class="back" onclick="location.href='<?php echo $backpath ?>'"><!--<i class="fas fa-undo-alt"></i> -->Back</button>
</div>
</form>
<?php } ?>
