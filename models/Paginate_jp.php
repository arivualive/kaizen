...
class Paginate
{
    ...
    public function pagenation($data)
    {
        ...
        //  echo '<li class="first"><a href="'.$this->path.'1'.$order.'">&laquo;</a></li>'."\n";
            echo '
                <li class="page-item first">
                    <a class="page-link" href="'.$this->path.'1'.$order.'" aria-label="Previous">««<span> 先頭へ</span></a>
                </li>
            ';
        }
        ...
        //  echo '<li class="prev"><a href="'.$this->path.($this->current_page - 1).''.$order.'">&lsaquo;</a></li>'."\n";
            echo '
                <li class="page-item">
                    <a class="page-link" href="'.$this->path.($this->current_page - 1).''.$order.'" aria-label="Previous">«<span> 前</span></a>
                </li>
            ';
        }
        ...
        //  echo '<li class="next"><a href="'.$this->path.($this->current_page + 1).''.$order.'">&rsaquo;</a></li>'."\n";
            echo '
                <li class="page-item">
                    <a class="page-link" href="'.$this->path.($this->current_page + 1).''.$order.'" aria-label="Next">次 </span>»</span></a>
                </li>
            ';
        }
        ...
        //  echo '<li class="last"><a href="'.$this->path.$this->total_page.''.$order.'">&raquo;</a></li>'."\n";
            echo '
                <li class="page-item last">
                    <a class="page-link" href="'.$this->path.$this->total_page.''.$order.'" aria-label="Next">最後へ </span>»»</span></a>
                </li>
            ';
        }
