...
$url=implode("-",$arr);
$status=1;
$query=mysqli_query($con,"insert into tblfaq_posts(PostTitle,PostDetails,PostUrl,Is_Active) values('$posttitle','$postdetails','$url','$status')");
if($query)
{
                  ...
                  <div class="">
                    <form name="addpost" method="post" enctype="multipart/form-data">
                      <div class="form-group m-b-20">
                        ...
                        <input type="text" class="form-control"  name="posttitle" placeholder=" <?php echo $lang['add_faq_ques']?>" required>
                      </div>
                      <div class="form-group m-b-20">
                        <label for="exampleInputEmail1"> <?php echo $lang['add_faq_ans']?>
                        </label>
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="card-box">
