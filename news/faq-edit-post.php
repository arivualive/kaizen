...
$status=1;
$uid=intval($_GET['uid']);
$query=mysqli_query($con,"update tblfaq_posts set PostTitle='$posttitle',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$uid'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <!-- App title -->
    <title>Kaizen | FAQ | Edit Update Info
    </title>
    <!-- Summernote css -->
      ...
      <div class="content-page">
        ...
        <div class="content">
          <div class="container">
            ...
            <?php
$uid=intval($_GET['uid']);
$query=mysqli_query($con,"select tblfaq_posts.id as uiid,tblfaq_posts.PostTitle as title,tblfaq_posts.PostDetails from tblfaq_posts  where tblfaq_posts.id='$uid' and tblfaq_posts.Is_Active=1 ");
