...
{
$uid=intval($_GET['uid']);
$query=mysqli_query($con,"update tblcms_posts set Is_Active=0 where id='$uid'");
if($query)
{
...
<html lang="en">
  <head>
    ...
    <!-- App title -->
    <title>Kaizen | News | Manage Posts
    </title>
    <!--Morris Chart CSS -->
              ...
              <div class="col-xs-12">
                <div class="page-title-box">
                  ...
                  <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active">
                    <?php echo  $lang['manage_post_name']?>
                    </li>
                  </ol>
                  <div class="clearfix">
                  </div>
                ...
                <div class="card-box">
                  <div class="table-responsive">
                    <table id="example2" class="display table table-striped table-bordered"
                      ...
                      <tbody>
                        <?php
$query=mysqli_query($con,"SELECT tblcms_posts.id as uiid,tblcms_posts.PostTitle as title,tblcms_posts.CreationDate as creationdate,tblcms_posts.Updationdate as updationdate FROM tblcms_posts WHERE tblcms_posts.Is_Active=1 ORDER BY tblcms_posts.id DESC ");
...
?>
                        <tr>
                          ...
                          <td>
                            <a href="news-edit-post.php?uid=<?php echo htmlentities($row['uiid']);?>">
                              <i class="fa fa-pencil" style="color: #29b6f6;" title="<?php echo  $lang['edit_post_name']?>">
                              </i>
                            </a> 
                            &nbsp;
                            <a href="news-manage-post.php?uid=<?php echo htmlentities($row['uiid']);?>&&action=del" onclick="return confirm('<?php echo $lang['manage_post_delete']?>;')">
