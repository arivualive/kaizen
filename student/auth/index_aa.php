...
if (isset($_POST['register'])) {
  ...
  $from = "cms_admin@e-kjs.jp";
    ...
    $message = "<html><body style=font-family:メイリオ leftmargin=10 topmargin=0 marginheight=0 marginwidth=0 height=100%>
                    ...
                    <tr><td>Dear ". strip_tags($_SESSION['fullname']) ." </td></tr><br>
                    <tr><td></td></tr>
...
<html lang="en">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center">
          ...
          <div class="col-md-5 relative align-self-center">
            ...
            <form class="bg-white rounded pb_form_v1" action=<?php echo $_SERVER['REQUEST_URI'] ?> method="POST">
    ...
    <section class="pb_section bg-light pb_slant-white pb_pb-250" id="section-introduction">
      ...
      <div class="row justify-content-center mb-2">
        ...
        <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 pl-md-12 pl-sm-12"><div class="media pb_feature-v2 text-left mb-1 mt-5">
                      <div class="media-body">

                      <h2>Kaizen is a Japanese methodology which has a proven track-record in improving productivity and quality. Kaizen has been increasingly adopted by organization around the world. Although Kaizen has started from industries, it is now spread out to all kinds of public and private sectors.</h2><br>
        ...
        <div class="row">
          <div class="col-md">
            <div class="pb_pricing_v1 p-5 border text-center bg-white">
              <h3 class="price">Registration for KAIZEN Member</h3><br>
          ...
          <div class="col-md">
            <div class="pb_pricing_v1 p-5 border  text-center bg-white">
              <h3 class="price">Login for the Microlearning platform</h3><br>
          ...
          <div class="col-md-5">
             <form  class="bg-white rounded pb_form_v1" method="POST" id="enquiery" autocomplete="off">
              ...
              <label for="exampleFormControlTextarea1">Enquiery Details </label>
                  <textarea class="form-control pb_height-150 reverse" name="message" required></textarea>
                </div>
              <div class="form-group">
