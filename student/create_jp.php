...
if (filter_has_var(INPUT_POST, "student_name")) {
    ...
    $curl_data = array('repository' => 'StudentRepository', 'method' => 'insertStudent', 'params' => $data);
    ...
    <dl>
		...
		<dd>
		    ...
		    <?php foreach ((array) $school_data as $item): ?>
				<option value="<?php echo $item['school_id']; ?>">
