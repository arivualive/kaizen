                ...
                <div class="modal-body">
                    ...
                    <ul class="btns">
                        ...
                        <form action='' method='post' name='send_form' id='send_form'>
                            <li class="submit" name="submit"><button form='send_form' id="submit">Reply with this content</button></li>
    ...
    <div id="container-maincontents" class="container-maincontents clearfix">
        <div id="message-detail">
            ...
            <div class="message-detail-title clearfix">
                <p class="text">Message reply</p>
                <ul class="btns">
                    <li><a href="message_list.php?p=1">Back to index</a></li>
                    <li><a href="message_detail.php?id=<?php echo $message_id ?>">Back to details</a></li>
                    <!-- <li><a>詳細へ戻る</a></li> -->
                </ul>
            </div>
            <div class="message-detail-box">
                ...
                <div class="message-create-body">
                    ...
                    <div id="destination-user" class="item">
                        ...
                        <div class="body">
                            <div id="select-user" class="select-category">
                                <!-- 管理者・教員 -->
                                <p class="category">Choose from admin / teacher</p>
                                <div class="clearfix">
                                    <div class="select-group">
                                        <div class="in">
                                            <p class="top">Administrator</p>
                                            <ul class="scrol">
                    ...
                    <div id="message-create" class="item">
                        ...
                        <div class="body">
                            ...
                            <div id="message-contents" class="input-category">
                                <p class="title">Message content<small>3 characters or more and 2000 characters or less</small></p>
                    ...
                    <div id="last-check" class="item">
                        ...
                        <div class="body">
                            <div>
                                <button data-toggle="modal" data-target="#Modal-messagecheck" id="modal-check">checking the detail</button>
                            </div>
                        </div>
                    </div>
                </div>
