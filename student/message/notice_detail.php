...
if(count($title_data) == 0){
    ...
    header('Location: /student/message/notice_list.php?p=1');
    exit();
} else {
    //メッセージの確認状況更新
            ...
            <div class="header-right">
                <nav class="nav-mainmenu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="notice_list.php?p=1"><span>message</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <div id="container-maincontents" class="container-maincontents clearfix">
        <div id="message-detail">
            ...
            <div class="message-detail-title clearfix">
                <p class="text">Message Details</p>
                <ul class="btns">
                    <li><a href="notice_list.php?p=1">back to index</a></li>
                ...
                <?php foreach ((array) $title_data as $item): ?>
                    ...
                    <?php if($item['type'] == 1) {
                        ...
                        <div class="message-detail-head type-public"><!-- お知らせ(notice)or公開(public)or非公開(private) -->
                            <p class="message-type">Public message</p>
                    '; }; ?>
                    <?php if($item['type'] == 2) {
                        echo '
...
<?php
    ...
    if(is_countable($receiver_data[0])){
      echo '<dd>... other' . (count($receiver_data[0]) - 10) . 'person</dd>' . "\n";
    }
...
?>
                    ...
                    <div class="talkerea">
                        ...
                        <?php if($item['type'] != 0) {
                            echo "
                            <div class='btn-reply'>
                                <a href='notice_reply.php?id=" . $message_id . "'>Send back</a>
                            </div>
                        "; }; ?>
                        <?php endforeach;?>
                                    ...
                                    ">
                                        <div class="head clearfix">
                                            ...
                                            <?php if($item['send_flag'] == 1) { echo "
                                                <button type='submit' form='delete' class='btn_delete' name='delete' value=" . $item['message_detail_id'] . ">Delete</button>
...
<?php
    ...
    // 2019/6/03 count関数対策
    if(is_countable($receiver_data[0])){
      echo '... other' . (count($receiver_data[0]) - 3) . 'person' . "\n";
    }
