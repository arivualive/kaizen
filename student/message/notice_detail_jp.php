            ...
            <div class="header-right">
                <nav class="nav-mainmenu">
                    <ul>
                        ...
                        <li class="active">
                            <a href="notice_list.php?p=1"><span>メッセージ</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
...
?>
                    ...
                    <div class="talkerea">
                        ...
                        <?php if($item['type'] != 0) {
                            echo "
                            <div class='btn-reply'>
                                <a href='notice_reply.php?id=" . $message_id . "'>返信する</a>
                            </div>
                        "; }; ?>
                        <?php endforeach;?>
                                    ...
                                    ">
                                        <div class="head clearfix">
                                            ...
                                            <?php if($item['send_flag'] == 1) { echo "
                                                <button type='submit' form='delete' class='btn_delete' name='delete' value=" . $item['message_detail_id'] . ">削除</button>
