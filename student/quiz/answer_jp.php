                    ...
                    <div class="question-itemgroup navbar-expand-lg">
                        ...
                        <ul class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                            <?php for($i = 0; $max_query > $i; $i++): ?>
                                <?php $num = $i + 1; ?>
                              <li<?php echo ($p == $i) ? ' class="active"' : ''; ?>><button><span>問題</span><?php echo $num; ?></button></li>
                            <?php endfor; ?>
                        </ul>
                    </div>
                    ...
                    <div class="question-main">
                        ...
                        <div class="question-contents">
                            <div class="question-head">
                                <!-- 問題番号 -->
                                <p class="number">問題<?php echo $p+1; ?></p><p>配点 <?php echo $query_data['score']; ?>点</p>
                            </div>
...
<p class="img"><img src="<?php echo $image_file_path; ?>" alt="画像" /></img>
<?php endif; ?>
                        ...
                        <div class="answer-btns">
                            <ul>
                                <li class="back"><button type="submit" name="submit" value="back">前へ</button></li>
                                <li class="next"><button type="submit" name="submit" value="answer">次へ</button></li>
                            </ul>
                        </div>
                        </form>
                    </div>
