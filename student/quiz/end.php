...
if ( $display_data[ 'flg' ] == 'false' || $display_data == 'false' ) {
  ...
  $display_data[ 'rq_result' ] = '<li><button data-result=result.php?id='.$quiz_id.'&an='.$answer_id .
    '&bid='. $bid .' class="score" id="quiz_result">View quiz results</button></li>';
 ...
 -->
                    ...
                    <div class="question-main">
                        ...
                        <form action=<?php echo $_SERVER['REQUEST_URI'] ?> method="POST">
                            <ul>
                            <li><button id="quiz_result" type="submit" name="action" value="result">View quiz results</button></li>
