                ...
                <div class="quiz-body">
                    <div class="quiz-body-result">
                        ...
                        <div class="quiz-count-select navbar-expand-lg">
                            <p class="head">Other attendance times</p>
                            <a class="navbar-toggler" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                                <span>Other attendance times</span>
                            </a>
                        ...
                        <div class="quiz-detail-points">
                            ...
                            <p class="study-day">Examination Date:<?php echo $register_datetime; ?></p>
                            <ul class="box-l clearfix">
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Score / Passing score</p>
                                        <p class="value"><big><?php echo $total_score; ?></big>point/
<?php echo $success_point; ?></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Pass or fail</p>
                                ...
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Rank / Number of exams</p>
                                    <?php if ($quiz_data['rank_flg'] == 1): ?>
                                        <p class="value"><big><?php echo $rank['rank']; ?></big> / <?php echo $examinees; ?>Times</p>
                                    <?php else: ?>
                                        <p class="value"><big>ー</big></p>
                                    <?php endif; ?>
                                    </div>
                            ...
                            <ul class="box-m clearfix">
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Average score</p>
                                    <?php if ($quiz_data['average_flg'] == 1): ?>
                                        <p class="value"><?php echo $average; ?>point</p>
                                    <?php else: ?>
                                        <p class="value">ー</p>
                                    <?php endif; ?>
                                    </div>
                                ...
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Pass count</p>
                                        <p class="value"><?php echo $success_count; ?>Times</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Deviation value</p>
                                ...
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">standard deviation</p>
                            ...
                            <ul class="box-m clearfix">
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Correct answer rate</p>
                                ...
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Overall accuracy rate</p>
                                        <p class="value"><?php echo $rate_all; ?>%</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Answer time/Time limit</p>
                                        <p class="value"><?php echo $answer_time; ?> / <small><?php echo $limit_time; ?></small></p>
                                    </div>
                                </li>
                                <li>
                                    <div class="in">
                                        <p class="itemtitle">Overall average answer time</p>
                ...
                <div class="answer-listitem">
                    <div class="head">
                        <div class="head-top clearfix">
                            <p class="number">question<?php echo $num; ?>&emsp;(<?php echo $query_data[$i]['score']; ?>point)</p>
                            <?php $flg = $Answer->findFlgRightQueryId($query_data[$i]['query_id']); ?>
                           <?php if ($quiz_data['correct_flg'] == 1): ?>
                            <?php if ($flg['flg_right'] == 1): ?>
                              <p class="result correct">Correct answer</p>
                            <?php else: ?>
                              <p class="result incorrect">Incorrect answer</p>
                            <?php endif; ?>
                           <?php endif; ?>
                        </div>
                    ...
                    <div class="body">
                        <div class="clearfix">
                                          ...
                                          <?php foreach ($choice as $item): ?>
                                            <?php if ($item['selection_id'] == $values['selection_id']) : ?>
                                              <?php if ($quiz_data['student_answer_flg'] == 1) : ?>
                                                <td class="user-answer"><span style="font-size:80%;">Your answer</span></td>
                                              <?php else: ?>
                                                <td></td>
                                              <?php endif; ?>
                                                <?php $flg = 1; ?>
                            ...
                            ?>
                            <div class="graph">
                                <p class="percent">Overall accuracy rate<span><?php echo ($answer_count['count'] != 0 && $answer_count['correct'] != 0) ? round($answer_count['correct'] / $answer_count['count'] * 100, 1): '0'; ?>%</span></p>
                                <div class="graph-image"><img src=""></div>
                            </div>
                            <div class="graph">
                            <?php
                             ...
                             <?php if (file_exists($image_file_path) || $image != ''): ?>
                                <img src="<?php echo $image_file_path; ?>" width="100%" alt="image" />
