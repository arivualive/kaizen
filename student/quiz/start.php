...
if (is_null($quiz_id)) {
    $error_message = "I do not know the quiz number";
    $error = 1;
}
                ...
                <div class="quiz-body">
                    ...
                    <div class="question-main">
                        ...
                        <div class="question-start">
                            <p>Start the quiz</p>
                            <p>
                                <small>all<?php echo $cnt; ?>Q</small>
                            </p>
                        </div>
                        <!-- 前へ　次へ -->
                        <div class="answer-btns">
                            ...
                            <form action=<?php echo $_SERVER['REQUEST_URI'] ?> method="POST">
                                <ul>
                                    ...
                                    <li><button type="submit" name="submit" value="start" <?php echo ($error)? 'disabled': '';?>>Start</button></li>
                                </ul>
                            </form>
                        </div>
                    </div>
