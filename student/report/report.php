...
<div id="wrap">
    ...
    <div id="container-maincontents" class="container-maincontents clearfix">
        ...
        <div class="sentence-top clearfix">
            <p class="text">Report creation</p>
            <ul class="btns">
        ...
        <div class="sentence-box">
            ...
            <?php if(filter_input(INPUT_POST, "sendFlag") == false) { ?>
                <!-- head -->
                <div class="sentence-head report">
                ...
                <div class="sentence-body" id="questionnaire_start" >
                    <div class="sentence-start">
                        ...
                        <p>Start report creation.</p>
                    </div>

                    <!-- 前へ　次へ -->
                    <div class="sentence-btns">
                        <ul>
                            <li><button class='start'>Create a report</button></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="sentence-btns">
                                <ul>
                                    <?php
                                        ...
                                        if($i == count($query_data) - 1) {
                                            echo "
                                                <li class='submit'><button>Send a report</button></li>
                                                <p id='cantion'>A required report item has not been created</p>
                                            ";
                                        }
                                    ?>
                                </ul>
            ...
            <?php } else { ?>
                ...
                <div class="sentence-body" id="questionnaire_start" >
                    ...
                    <div class="sentence-btns">
                        <ul>
                            <li class='list'><button id="return">Return to the lecture list</button></li>
                        </ul>
                    </div>
                </div>
            <?php } ?>
