...
if (filter_input(INPUT_POST, "sendFlag") == true) {
    ...
    if(count($data['message_target_id'])) {
        header('Location: /admin/template/message/message_list.php?p=1');
    } else {
                ...
                <div class="message-create-body">
                    ...
                    <div id="message-create" class="item">
                        ...
                        <div class="body">
                            ...
                            <!-- メッセージタイプ -->
                            <div id="message-type" class="input-category">
                                <p class="title">メッセージのタイプ</p>
                                <div class="input-erea">
                                    <label><p>お知らせ</p><input type="radio" name="type" class="input-type" value=0 ?></label>
                                    <label><p>公開メッセージ</p><input type="radio" name="type" class="input-type" value=1 ?></label>
                                    <label><p>非公開メッセージ</p><input type="radio" name="type" class="input-type" value=2 ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
